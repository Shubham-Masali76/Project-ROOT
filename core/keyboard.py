...
Available Terminal Commands:
  /silent   - Mute Text-to-Speech (stealth mode)
  /voice    - Restore Text-to-Speech
  /mic off  - Mute the microphone (stop listening)
  /mic on   - Unmute the microphone
  /help     - Show this menu
  /exit     - Shut down all systems
================================================
Type a command or speak to the microphone...
"""
